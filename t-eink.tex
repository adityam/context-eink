...
% Kindle uses the 15pt space in the bottom 
\definepapersize
  [eink]
  [
...
\setuplayout
  [
    \c!location=\v!middle,
    \c!topspace=0.5\lineheight,
    \c!width=\v!middle,
    \c!height=\v!middle,
    \c!bottomspace=0.5\lineheight,
    \c!bottomdistance=\zeropoint,
    \c!bottom=0.8\lineheight,
    \c!backspace=5mm,
    \c!cutspace=5mm,
    \c!leftmargin=1mm,
    \c!rightmargin=1mm,
...
\startsetups current:chapter
  \limitatetext {\getmarking[\v!chapter]}{0.5 \textwidth}{\unknown}
\stopsetups

\startsetups next:chapter
  \limitatetext {\getmarking[\v!chapter][last]}{0.5 \textwidth}{\unknown}
\stopsetups
